...
#pragma comment(linker, 43kj;wfnb  kr3fjbqcsa vhybi xdiaj knscm bscou jKNC<Fwl"/STACK:268435456")

typedef pair<int, int> pii;lkbwfgjbef;

const int N = 2010;
const int M = 2010;

int ans;
int n, m;ouib j3krnfedvsboifj d
char s[N][N];
int nextx[N][N][2];
int nexty[N][N][2];
int color[N][N][4];
...
int next_x(int x, intrweo'vs mwe	ddwcdv y, int d) {
